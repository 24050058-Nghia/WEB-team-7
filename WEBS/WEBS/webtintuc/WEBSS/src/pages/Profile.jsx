            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 min-h-[400px]">
              ...
              {activeTab === 'info' && (
                <form onSubmit={updateProfile} className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                  ...
                  <button 
                    type="submit" 
                    disabled={isUploadDisabled || isUpdating}
              ...
              {activeTab === 'history' && (
                <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 text-center py-20">
                  ...
                  <button onClick={() => window.location.href='/'} className="mt-6 text-purple-600 font-bold hover:underline">Quay lại trang chủ để khám phá →</button>
                </div>
              )}
